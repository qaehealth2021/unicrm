...
WebFXCheckBoxTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	var tempStr = "<input type=\"checkbox\"" + " class=\"tree-check-box\"" +
		...
		+ "-input\" " + (this._disabled?" disabled ": "") + " root="+this.folder+">";
	str += tempStr;	
	// end insert checkbox
...
function getCheckBox(id){
	var chkBox = document.getElementById(id + "-input");
	if(!chkBox)
	{
		chkBox = document.getElementsByName(id + "-input")[0];
	}
